...
static_assert(std::is_same_v<banana::api_result<banana::api::message_t, banana::agent::default_blocking_monadic>, banana::expected<banana::api::message_t>>);
static_assert(std::is_same_v<banana::api_result<banana::api::message_t, banana::agent::default_blocking>, banana::api::message_t>);
...
int main(int argc, const char** argv) {
    ...
    try {
        banana::agent::default_blocking_monadic agent(token);
