.. _banana-api-tg-methods-send_paid_media:
...
.. cpp:struct:: send_paid_media_args_t

   Arguments that should be passed to :cpp:func:`send_paid_media`.
   ...
   .. cpp:member:: array_t<input_paid_media_t> media

   A JSON-serialized array describing the media to be sent; up to 10 items

   .. cpp:member:: optional_t<string_t> payload
