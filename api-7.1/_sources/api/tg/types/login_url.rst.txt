.. _banana-api-tg-types-login_url:

login_url_t
===========

.. cpp:struct:: banana::api::login_url_t
   ...
   .. cpp:member:: optional_t<string_t> forward_text

   Optional. New text of the button in forwarded messages.

   .. cpp:member:: optional_t<string_t> bot_username

   Optional. Username of a bot, which will be used for user authorization. See Setting up a bot for more details. If not specified, the current bot's username will be assumed. The url's domain must be the same as the domain linked with the bot. See Linking your domain to the bot for more details.

   .. cpp:member:: optional_t<boolean_t> request_write_access
