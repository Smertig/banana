.. _banana-api-tg-methods-set_my_short_description:
...
.. cpp:struct:: set_my_short_description_args_t

   Arguments that should be passed to :cpp:func:`set_my_short_description`.


   .. cpp:member:: optional_t<string_t> short_description
