...
static_assert(std::is_same_v<banana::api_result<banana::api::message_t, banana::agent::winapi_async>, std::future<banana::api::message_t>>);
...
int main(int argc, const char** argv) {
    ...
    try {
        banana::agent::winapi_async agent(token);
