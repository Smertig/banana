...
static_assert(std::is_same_v<banana::api_result<banana::api::message_t, banana::connector::default_async>, std::future<banana::api::message_t>>);
...
int main(int argc, const char** argv) {
    ...
    try {
        banana::connector::default_async connector(token);
