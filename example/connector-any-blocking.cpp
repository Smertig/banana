...
#include <banana/connector/any.hpp>

#include <iostream>

static_assert(std::is_same_v<banana::api_result<banana::api::message_t, banana::connector::any_blocking_monadic>, banana::expected<banana::api::message_t>>);
static_assert(std::is_same_v<banana::api_result<banana::api::message_t, banana::connector::any_blocking>, banana::api::message_t>);
...
int main(int argc, const char** argv) {
    ...
    try {
        banana::connector::any_blocking connector = banana::connector::default_blocking(token);
    ...
    try {
        banana::connector::any_blocking_monadic connector = banana::connector::default_blocking_monadic(token);
