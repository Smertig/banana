...
static_assert(std::is_same_v<banana::api_result<banana::api::message_t, banana::connector::any_async>, std::future<banana::api::message_t>>);
...
int main(int argc, const char** argv) {
    ...
    try {
        banana::connector::any_async connector = banana::connector::default_async(token);
