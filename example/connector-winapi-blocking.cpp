...
static_assert(std::is_same_v<banana::api_result<banana::api::message_t, banana::connector::winapi_blocking_monadic>, banana::expected<banana::api::message_t>>);
static_assert(std::is_same_v<banana::api_result<banana::api::message_t, banana::connector::winapi_blocking>, banana::api::message_t>);
...
int main(int argc, const char** argv) {
    ...
    try {
        banana::connector::winapi_blocking connector(token);
    ...
    try {
        banana::connector::winapi_blocking_monadic connector(token);
